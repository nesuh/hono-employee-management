...
ALTER TABLE "positions" ADD CONSTRAINT "positions_parentId_positions_id_fk" FOREIGN KEY ("parentId") REFERENCES "public"."positions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
